...
sub Chooser {
    print start_blockquote, h2("MDR Portal Administration");
    # print start_form;
    # print "popup_menu or list of buttons with short descriptions";
    # print end_form;
    print ul(li([a({href=>'patient.cgi'}, 'Patients'),
		 a({href=>'antibio.cgi'}, 'Antibiotics'),
		]));
